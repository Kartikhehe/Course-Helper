...
function Homepage() {
  ...
  const fetchCourses = () => {
    ...
    fetch("https://course-helper-updated-backend.vercel.app/courses", {
      headers: {
   ...
   const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://course-helper-updated-backend.vercel.app/courses/${id}`, {
        method: "DELETE",
        headers: {
  ...
  const handleUpdate = (id, updatedCourse) => {
    fetch(`https://course-helper-updated-backend.vercel.app/courses/${id}`, {
      method: "PUT",
      headers: {
  ...
  const addCourse = async (newCourse) => {
    ...
    try {
      const response = await fetch("https://course-helper-updated-backend.vercel.app/courses", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
